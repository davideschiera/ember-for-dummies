...
The learning curve might appear steep sometimes, but most of time times you just get stuck in silly problems with easy solutions. Hopefully this list will point you to the easy solution immediately.


## To start

These links will always be opened in your browser:
...
First of all, read [the Ember CLI guide](http://www.ember-cli.com/) a few times.
